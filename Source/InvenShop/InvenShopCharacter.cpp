...
AInvenShopCharacter::AInvenShopCharacter()
{
...
void AInvenShopCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void AInvenShopCharacter::MoveForward(float Value)
{
...
void AInvenShopCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
